    ...
    <section className="sponsors">
      ...
      <div class="grid grid-3">
        <div class="card">
          ...
          <div class="circle">
            <img class="circle__image" src={logo1} alt="" />
          </div>
        </div>
        <div class="card">
          ...
          <div class="circle">
            <img class="circle__image" src={logo2} alt="" />
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="circle">
            <img class="circle__image" src={logo3} alt="" />
          </div>
        </div>
        <div class="card">
          ...
          <div class="circle">
            <img class="circle__image" src={logo4} alt="" />
          </div>
        </div>
        ...
        <div class="card">
          ...
          <div class="circle">
            <img class="circle__image" src={logo5} alt="" />
          </div>
        </div>
        <div class="card">
          ...
          <div class="circle">
            <img class="circle__image" src={logo6} alt="" />
          </div>
        </div>
      </div>
    </section>
